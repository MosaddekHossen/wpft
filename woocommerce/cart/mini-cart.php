						...
						<button class="cartmini__del">
							...
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr(sprintf(__('Remove %s from cart', 'harry'), wp_strip_all_tags($product_name))),
									esc_attr($product_id),
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e('No products in the cart.', 'harry'); ?></p>
