...
$harry_side_shape_switch = get_theme_mod('harry_side_shape_switch', __('#', 'harry'));
$harry_side_logo_switch = get_theme_mod('harry_side_logo_switch', __('#', 'harry'));
$harry_side_menu_switch = get_theme_mod('harry_side_menu_switch', __('#', 'harry'));
$harry_side_social_switch = get_theme_mod('harry_side_social_switch', __('#', 'harry'));
?>
